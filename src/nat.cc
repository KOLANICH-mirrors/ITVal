...
void
BreakNAT (char *str, nat_range * &NATRange, char prot, Firewall * FW)
{
  char *ch;
  char word1[1024];
  char word2[1024];
...
void
BreakNMAP (char *str, nat_range * &NATRange, Firewall * FW)
{
  char *ch;
  char word1[1024];
  int length;
...
void
ProcessNATInfo (char *info, processed_nat_rule * p, Firewall * FW, rule_parser* rp)
{
...
void
ProcessNATRule (rule * r, processed_nat_rule * p, Firewall * FW, rule_parser* rp)
{
