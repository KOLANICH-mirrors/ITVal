...
debug: fwlang.tab.cc main.cc work/nat.o work/structures.o work/iface.o work/netconvert.o work/rules.o work/rule_parser.o work/chains.o FDDL/fddl.so work/nat_iface.o work/firewall.o
	$(GXX) lex.yy.c fwlang.tab.c work/nat.o work/structures.o work/iface.o work/netconvert.o work/rules.o work/rule_parser.o work/chains.o work/nat_iface.o main.cc work/firewall.o FDDL/fddl.so debug.cc -o ITVal 
        
ITVal: fwlang.tab.c main.cc work/nat.o work/structures.o work/iface.o work/netconvert.o work/rules.o work/rule_parser.o work/chains.o work/firewall.o FDDL/fddl.so work/nat_iface.o
	$(GXX) lex.yy.c fwlang.tab.c work/nat.o work/structures.o work/iface.o work/netconvert.o work/rules.o work/rule_parser.o work/nat_iface.o work/chains.o work/firewall.o main.cc FDDL/fddl.so debug.cc -o ITVal 

fwlang.tab.h: fwlang.y lex.yy.c
	bison -d fwlang.y
	
fwlang.tab.c: fwlang.y lex.yy.c
	bison -d fwlang.y

lex.yy.c: fwlang.l fwlang.tab.h
	flex fwlang.l
        
work/chains.o: chains.cc rules.h ranges.h iface.h chains.h debug.h
	$(GXX) -c chains.cc -o work/chains.o

work/rule_parser.o: rule_parser.cc rules.h
	$(GXX) -c rule_parser.cc -o work/rule_parser.o

work/rules.o: rules.cc rules.h 
	$(GXX) -c rules.cc -o work/rules.o
...
work/netconvert.o: netconvert.cc ranges.h
	$(GXX) -c netconvert.cc -o work/netconvert.o

work/iface.o: iface.cc iface.h chains.h
	$(GXX) -c iface.cc -o work/iface.o

work/structures.o: structures.cc structures.h FDDL/mdd.h
	$(GXX) -c structures.cc -o work/structures.o
