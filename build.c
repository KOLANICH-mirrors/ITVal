...
/*
 * Syntax: ipt_query <rule_file> <query_file>
 
 * rule_file should be generated by iptables -L -n so 
 * that it generates numeric addresses and port numbers.
 
 * query_file should contain queries as documented in 
 * the manual.  Uses an MDD representation of the 
 * ruleset to solve the queries.
 */
...
void Firewall::ReadChain(char *line, ssize_t length, chain * newChain)
{
	...
	// The default policy only be "ACCEPT" or "DROP".
